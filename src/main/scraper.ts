...
function fetchText(url: string): Promise<string> {
  return new Promise((resolve, reject) => {
    const req = httpsGet(url, { headers: { 'User-Agent': 'OmniEmu/0.2.0' }, timeout: 10000 }, (res) => {
      let data = '';
...
const mobygamesUA = 'Mozilla/5.0 (compatible; OmniEmu/0.2.0; +https://github.com/mileswolfallen2/OmniEmu2.0)';
